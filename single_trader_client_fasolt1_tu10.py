...
brokerport=5671
username="testuser_10@testdomain.com"
userpw="passu123"
...
def start_client(args):
    if args.mpnum == 1:
        procnum=1
        apptoken='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI1ZGRmYWM2MTBkZmY1MTQ2OGNhOGM1YmIiLCJ1dWlkIjoiNjJiZmM1OTItMDk5MS00ZDRiLTg1ZGMtNmRjMTczZjM0OTYzIiwiaWF0IjoxNTc0OTM5NzU5LCJleHAiOjE2Njk1NDc3NTl9.vzda7h5kGb8EwdFD511vWZZbwK54HEpMxmTlW4N1wPM'
        known_appkey='5ddfac6f0dff51468ca8c5bd'
    if args.mpnum == 2:
        procnum=2
